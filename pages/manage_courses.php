...
require_capability('local/grupomakro_core:manage_courses', context_system::instance());
...
$PAGE->requires->js(new moodle_url('/local/grupomakro_core/js/manage_courses.js'));
