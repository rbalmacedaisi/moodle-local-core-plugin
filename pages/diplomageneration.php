...
$strings->delete = get_string('diploma_delete', $plugin_name);
$strings->delete_confirm = get_string('diploma_delete_confirm', $plugin_name);
$strings->deleted_ok = get_string('diploma_deleted_ok', $plugin_name);
...
$strings->course_filter = get_string('diploma_course_filter', $plugin_name);
$strings->course_all = get_string('diploma_course_all', $plugin_name);
$strings->course_enable = get_string('diploma_course_enable', $plugin_name);
$strings->course_disable = get_string('diploma_course_disable', $plugin_name);
$strings->course_status = get_string('diploma_course_status', $plugin_name);
$strings->course_grade = get_string('diploma_course_grade', $plugin_name);
$strings->course_progress = get_string('diploma_course_progress', $plugin_name);
$strings->course_approved_at = get_string('diploma_course_approved_at', $plugin_name);
$strings->course_ready = get_string('diploma_course_ready', $plugin_name);
$strings->course_not_approved = get_string('diploma_course_not_approved', $plugin_name);
$strings->course_has_diploma = get_string('diploma_course_has_diploma', $plugin_name);
$strings->course_no_students = get_string('diploma_course_no_students', $plugin_name);
