...
<style>
    ...
    .dpl-canvas-wrap { position: relative; width: 100%; margin: 0 auto; padding: 16px; background: #f4f4f4; border-radius: 8px; overflow: auto; box-shadow: 0 2px 10px rgba(0,0,0,.08); display: flex; justify-content: center; }
