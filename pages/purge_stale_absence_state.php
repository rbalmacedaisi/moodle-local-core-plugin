...
echo '<p>Elimina filas de <code>gmk_class_absence_state</code> cuyo (userid, classid) ya no está matriculado activamente (status = 2 "Cursando" en <code>gmk_course_progre</code>).</p>';
