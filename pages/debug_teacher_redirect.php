...
// Only Admins should see the FULL list, but let anyone see their own simulation
require_login();
$context = context_system::instance();
// REMOVED: require_capability('moodle/site:config', $context);
...
$PAGE->set_pagelayout('standard'); // Changed to standard so it works for anyone
...
// ONLY SHOW FULL TABLE TO ADMINS
if (has_capability('moodle/site:config', $context)) {
    ...
    echo "<div class='alert alert-info'>Debes ser Administrador para ver el listado global de docentes.</div>";
}
