...
//
// Receives module invoice payment notifications from the Express proxy
// (forwarded from Odoo) and marks the gmk_module_invoice_requests row as paid.
...
try {
    ...
    $configuredtoken = (string)get_config('local_grupomakro_core', 'module_webhook_token');
    if ($configuredtoken === '') {
    ...
    $result = module_invoice_manager::handle_payment_webhook($payload);
