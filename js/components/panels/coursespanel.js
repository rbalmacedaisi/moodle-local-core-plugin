// Courses Panel Component for Student Timeline
Vue.component('courses-panel', {
    template: 
    ...
    methods: {
        loadCourses: function() {
            ...
            fetch(wsUrl + '?wstoken=' + token + '&wsfunction=local_grupomakro_get_courses_by_learning_plan&moodlewsrestformat=json&learningplanid=' + this.learningPlanId)
