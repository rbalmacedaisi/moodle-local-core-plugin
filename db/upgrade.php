...
function xmldb_local_grupomakro_core_upgrade($oldversion) {
  ...
  if ($oldversion < 20240130001) {
    ...
    // 20261001024: no schema changes; the new admin_delete_wellness_event WS is
    // picked up by purge_caches via services.php.
    if ($oldversion < 20261001024) {
    ...
    if ($oldversion < 20261001061) {
        // Director Academico: modo de edicion del curso (actividades).
        assign_capabilities_to_internal_roles();
