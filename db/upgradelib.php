...
function assign_capabilities_to_internal_roles() {
    ...
    $role_caps = [
        ...
        'gmk_secretaria_academica' => [
            ...
            'mod/assign:grade',
            'mod/assign:viewgrades',
            // 20261001071: mismo bundle que el Director en 20261001069 -ver los
            // comentarios de alla-. Sin accessallgroups la Secretaria tampoco
            // veia envios en las tareas de grupos separados aunque tuviera
            // mod/assign:grade. Mismas exclusiones: quiz:deleteattempts,
            // assign:editothersubmission, revealidentities y notificaciones.
            'moodle/site:accessallgroups',
            'moodle/site:viewfullnames',
            'moodle/site:manageblocks',
            'moodle/course:viewhiddensections',
