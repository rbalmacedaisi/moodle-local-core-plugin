 ...
 */
class create_institution extends external_api {
    ...
    public static function execute(
        ...
        try{
            ...
            $newInstitution->timemodified = time();
            $newInstitution->usermodified = $USER->id;
            
            $newInstitution->id = $DB->insert_record('gmk_institution', $newInstitution);
