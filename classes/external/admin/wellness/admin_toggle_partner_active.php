...
/**
 * Admin: toggle a partner's active flag (soft delete / restore). RF-09.1.
 *
...
class admin_toggle_partner_active extends external_api {

    public static function execute_parameters() {
        return new external_function_parameters([
            'id'     => new external_value(PARAM_INT,  'Partner id', VALUE_REQUIRED),
    ...
    public static function execute($id, $active) {
        ...
        $ok = \local_grupomakro_core\local\wellness_partner_manager::set_active(
