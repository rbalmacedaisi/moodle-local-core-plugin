...
class create_class extends external_api {
    ...
    public static function execute(
        ...
        $newlearningplan->name     = 'test';
        $newlearningplan->type          = 1;
        $newlearningplan->instance   = 2;
        $newlearningplan->learningplanid   = 0;
        $newlearningplan->periodid     = 0;
        $newlearningplan->courseid     = 0;
        $newlearningplan->instructorid   = 0;
        $newlearningplan->inittime     = '16:00';
        $newlearningplan->endtime  = '18:00';
        $newlearningplan->classdays  = '1/0/1/0/0/0/0';
        $newlearningplan->usermodified = $USER->id;
        $newlearningplan->timecreated = time();
        $newlearningplan->timemodified = time();
        
        $learningplanid = $DB->insert_record('gmk_class', $newlearningplan);
        var_dump($learningplanid);
        die();
